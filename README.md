...
- **Risk:** competitors fork the public repo.
  **Mitigation:** AGPL-3.0 enforces openness; hosted connectors, defaults
  data, and format maintenance remain the paid story.
...
- **Language / framework:** FastAPI (Python) backend — engine,
  SchemeAdapters and connectors as Python packages; SvelteKit exclusively
  as frontend (Decision 0009); contract via OpenAPI → generated TS types
